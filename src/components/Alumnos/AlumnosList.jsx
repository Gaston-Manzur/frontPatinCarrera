...
const AlumnoList = () => {
  ...
  const fetchAlumnos = () => {
    axios
      .get('https://backendpatincarrera.onrender.com/api/alumnos')   /*http://localhost:5000 */
  ...
  {alumnos.map((alumno) => (
    ...
    <li className='item-card' key={alumno._id}>
       <div className="card">
      { <img src={`https://backendpatincarrera.onrender.com/uploads/${alumno.foto}`} alt={`${alumno.nombre} ${alumno.apellido}`} className="card-img"  />}
